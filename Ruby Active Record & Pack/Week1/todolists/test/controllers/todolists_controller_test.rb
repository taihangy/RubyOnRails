...
class TodolistsControllerTest < ActionController::TestCase
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post :create, todolist: { list_due_date: @todolist.list_due_date, list_due_date: @todolist.list_due_date, list_name: @todolist.list_name }
    end
  ...
  test "should update todolist" do
    patch :update, id: @todolist, todolist: { list_due_date: @todolist.list_due_date, list_due_date: @todolist.list_due_date, list_name: @todolist.list_name }
    assert_redirected_to todolist_path(assigns(:todolist))
  end
