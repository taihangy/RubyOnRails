...
class Assignment
  ...
  def find_allusers(offset, limit)
      ...
      allusers = User.offset(offset).limit(limit).order(:updated_at)
  end
  ...
  def find_alllists(offset, limit)
      ...
      alllists = TodoList.offset(offset).limit(limit).order(list_due_date: :desc)
  end
  ...
  def find_user_byname(username)
      ...
      byname = User.where({username: username})
  end 
  ...
  def find_todolist_byname(name)
      ...
      todolist_byname = TodoList.where({list_name: name})
  end     
  ...
  def get_todolist_byid(id)
      ...
      todolist_byid = TodoList.find(id)
  end
